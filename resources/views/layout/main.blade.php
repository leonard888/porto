...
<body data-spy="scroll" data-target=".fixed-top">
  ...
  <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
    ...
    {{-- <a class="navbar-brand logo-text page-scroll" href="index.html">Leonard Lesmana</a> --}}

    <!-- Image Logo -->
    <a class="navbar-brand logo-image" href="/"><img src="{{asset('style/images/logo.png')}}" alt="alternative" style="width:60px; height:100px;"></a>
